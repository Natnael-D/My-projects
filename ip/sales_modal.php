    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Orders Full Details</h4></center>
            </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($drow=$dquery->fetch_array()){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"> <?php echo number_format($drow['price'], 2); echo " ETB"; ?></td>
                            ...
                            <tr>
                                ...
                                <td class="text-right"> <?php echo number_format($row['total'], 2); echo " ETB"; ?></td>
                            </tr>
                        </tbody>
                    </table>
